...
para_num(){
  if test $# -lt 1; then
    echo "Please Input data file realpath(/data/DAQ/Beam_2510/*.dat) or plus another output ROOTNAME "
    exit 1
  fi
}
...
scp lunon@192.168.7.150:$DATAFILEPATH /home/kkbo/beamtest/data/
