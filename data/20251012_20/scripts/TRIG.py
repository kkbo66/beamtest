...
def on_parameter_setup():
    ...
    #dmx_broadcast("TRIG", "TRIG", 1,0xBA, [0xFF82FF])#5k
    time.sleep(0.05)

    #dmx_broadcast("TRIG", "TRIG", 1,0xBA, [0xFFC1FF])#1k
    #time.sleep(0.05)

    dmx_broadcast("TRIG", "TRIG", 1,0xBA, [0xFFC2FF])#500
    time.sleep(0.05)
  
    #dmx_broadcast("TRIG", "TRIG", 1,0xBA, [0xFFCAFF])#100
    #time.sleep(0.05)

   #dmx_broadcast("TRIG", "TRIG", 1,0xBAF2FF, [0xFFCAFF])#20
   #time.sleep(0.05)
