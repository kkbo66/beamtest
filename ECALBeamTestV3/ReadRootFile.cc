...
int main(int argc, char const *argv[]){
  ...
  for(int k=0;k<25;k++){
    ...
    h3[k] = new TH1D(histname3.data(),"",100,1600,17000);
    h4[k] = new TH1D(histname4.data(),"",100,1600,5000);
    //h3[k] = new TH1D(histname3.data(),"",5000,1600,17000);
    //h4[k] = new TH1D(histname4.data(),"",500,1600,17000);
