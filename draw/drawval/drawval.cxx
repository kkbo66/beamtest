...
void drawval(TString rootname){
  ...
  TFile *fout = new TFile("/home/kkbo/beamtest/draw/figureroot/val-"+filename+".root", "RECREATE");
  fout->cd();
  cTemp1->Write();
  cTemp2->Write();
  cLPed->Write();
  ...
  fout->Close();
  //cTemp1->Print("/home/kkbo/beamtest/draw/pdf/temp1.pdf");
  //cTemp2->Print("/home/kkbo/beamtest/draw/pdf/temp2.pdf");
  //cLPed->Print("/home/kkbo/beamtest/draw/pdf/lped.pdf");
  //cHPed->Print("/home/kkbo/beamtest/draw/pdf/hped.pdf");
  //cLPeak->Print("/home/kkbo/beamtest/draw/pdf/lpeak.pdf");
  //cHPeak->Print("/home/kkbo/beamtest/draw/pdf/hpeak.pdf");
  //cLAmpl->Print("/home/kkbo/beamtest/draw/pdf/lampl.pdf");
  //cHAmpl->Print("/home/kkbo/beamtest/draw/pdf/hampl.pdf");
  //cLNoise->Print("/home/kkbo/beamtest/draw/pdf/lnoise.pdf");
  //cHNoise->Print("/home/kkbo/beamtest/draw/pdf/hnoise.pdf");
  //cTime->Print("/home/kkbo/beamtest/draw/pdf/time.pdf");
  //cEventID->Print("/home/kkbo/beamtest/draw/pdf/eventid.pdf");
  //cTriggerID->Print("/home/kkbo/beamtest/draw/pdf/triggerid.pdf");
}
